...
import ReusablePopup from "./AlertButton"
        ...
        <div className=" flex   items-center gap-3 px-3 py-2 md:gap-4 md:px-4 relative">
          ...
          <div className="ml-auto flex items-center gap-2">
            <button onClick={() => setOpenAlert(true)}
              type="button" className="rounded-full p-2 text-foreground hover:bg-accent" aria-label="Notifications">
              <FaBell className="h-5 w-5 md:h-6 md:w-6" />

            </button>
            <Avatar className="h-7 w-7 md:h-10 md:w-10" onClick={() => setOpen(true)}
            >
